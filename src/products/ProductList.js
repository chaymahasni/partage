  ...
  return (
    <ul className="list-group list-group-flush rounded">
      <li className="list-group-item d-none d-lg-block">
        <h5 className="mt-1 mb-2">Parcourir</h5>
      ...
      <li className="list-group-item">
        <h5 className="mt-1 mb-1">Marques</h5>
      ...
      <li className="list-group-item">
        <h5 className="mt-1 mb-2">Échelle des prix</h5>
        <div className="d-grid d-block mb-3">
          <div className="form-floating mb-2">
            <input
              ...
              placeholder="Min"
              defaultValue="100000 TND"
            />
            <label htmlFor="floatingInput">Prix ​​minimum</label>
          </div>
          <div className="form-floating mb-2">
            <input
              type="text"
              className="form-control"
              placeholder="Max"
              defaultValue="500000 TND"
            />
            <label htmlFor="floatingInput">Prix ​​maximum</label>
          </div>
